 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | Func | GUI  |Lower | Enter|Pg-dwn| Pg-up| Space|Raise | Left | Down |  Up  |Right |
 * `-------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LALT, MO(_FUNCTION), KC_LGUI, LOWER, KC_ENT, KC_PGDN, KC_PGUP, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
